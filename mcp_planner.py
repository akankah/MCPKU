...
async def plan_generate(goal: str, name: str, target_dir: str = "") -> str:
    ...
    Args:
        ...
        target_dir: The directory where the workflow file will be saved (default: E:/MCPKU/workflows/).
    """
    ...
    # 3. Handle target directory
    base_dir = Path(target_dir) if target_dir else (Path(__file__).parent / "workflows")
