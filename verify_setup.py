...
EXPECTED_SERVERS = {
    ...
    "browser", "diagnostics", "autofix", "context7",
}
...
def cmd_check():
    """Verify all 16 MCPs are correctly registered in global config."""
    print("=" * 60)
