...
TOOL_MANIFEST: dict[str, ToolEntry] = dict([
    ...
    _entry("fs_read_file", "mcp_filesystem", "read_file",
           category="files", description="Read file contents", parallel_ok=True),
    _entry("fs_read_multiple_files", "mcp_filesystem", "read_multiple_files",
           category="files", description="Read multiple files at once", parallel_ok=True),
    ...
    _entry("fs_list_directory", "mcp_filesystem", "list_directory",
           category="files", description="List directory contents", parallel_ok=True),
    _entry("fs_list_directory_detailed", "mcp_filesystem", "list_directory_detailed",
           category="files", description="List directory with details", parallel_ok=True),
    _entry("fs_directory_tree", "mcp_filesystem", "directory_tree",
           category="files", description="Recursive directory tree", parallel_ok=True),
    ...
    _entry("fs_search_files", "mcp_filesystem", "search_files",
           category="files", description="Search files by glob pattern", parallel_ok=True),
    _entry("fs_grep_files", "mcp_filesystem", "grep_files",
           category="files", description="Search file contents by regex", parallel_ok=True),
    _entry("fs_glob_pattern", "mcp_filesystem", "glob_pattern",
           category="files", description="Match paths by glob", parallel_ok=True),
    _entry("fs_get_file_info", "mcp_filesystem", "get_file_info",
           category="files", description="Get file metadata", parallel_ok=True),
    _entry("fs_path_exists", "mcp_filesystem", "path_exists",
           category="files", description="Check if path exists", parallel_ok=True),
    _entry("fs_list_allowed_directories", "mcp_filesystem", "list_allowed_directories",
           category="files", description="List allowed access directories", parallel_ok=True),
    _entry("fs_diff_files", "mcp_filesystem", "diff_files",
           category="files", description="Show diff between files", parallel_ok=True),
