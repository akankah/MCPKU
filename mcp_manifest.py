...
TOOL_MANIFEST: dict[str, ToolEntry] = dict([
    ...
    _entry("encoding_list_encodings", "mcp_encoding", "list_encodings",
           category="refactor", description="List available encodings", parallel_ok=True),
    _entry("encoding_convert_encoding", "mcp_encoding", "convert_encoding",
           category="refactor", description="Convert text between encodings", parallel_ok=True),
    _entry("encoding_detect_encoding", "mcp_encoding", "detect_encoding",
           category="refactor", description="Detect encoding of bytes", parallel_ok=True),
    _entry("encoding_unicode_normalize", "mcp_encoding", "unicode_normalize",
           category="refactor", description="Normalize Unicode text", parallel_ok=True),
    _entry("encoding_unicode_escape", "mcp_encoding", "unicode_escape",
           category="refactor", description="Escape Unicode characters", parallel_ok=True),
    _entry("encoding_unicode_unescape", "mcp_encoding", "unicode_unescape",
           category="refactor", description="Unescape Unicode characters", parallel_ok=True),
    _entry("encoding_encode_base64", "mcp_encoding", "encode_base64",
           category="refactor", description="Base64 encode/decode", parallel_ok=True),
    _entry("encoding_encode_hex", "mcp_encoding", "encode_hex",
           category="refactor", description="Hex encode/decode", parallel_ok=True),
    _entry("encoding_encode_url", "mcp_encoding", "encode_url",
           category="refactor", description="URL percent-encode/decode", parallel_ok=True),
    _entry("encoding_repair_encoding", "mcp_encoding", "repair_encoding",
           category="refactor", description="Repair mojibake text", parallel_ok=True),
    _entry("encoding_char_info", "mcp_encoding", "char_info",
           category="refactor", description="Get Unicode character info", parallel_ok=True),

    # ── Code Analyzer (Static Analysis) ──
    _entry("codeanalyzer_analyze_file", "mcp_code_analyzer", "analyze_file",
           category="refactor", description="Deep analysis of a source file", parallel_ok=True),
    _entry("codeanalyzer_analyze_project", "mcp_code_analyzer", "analyze_project",
           category="refactor", description="Analyze project structure", parallel_ok=True),
    _entry("codeanalyzer_complexity_report", "mcp_code_analyzer", "complexity_report",
           category="refactor", description="Cyclomatic complexity report", parallel_ok=True),
    _entry("codeanalyzer_dependency_graph", "mcp_code_analyzer", "dependency_graph",
           category="refactor", description="Extract import dependency graph", parallel_ok=True),
    _entry("codeanalyzer_security_scan", "mcp_code_analyzer", "security_scan",
           category="debug", description="Scan for security vulnerabilities", parallel_ok=True),
    _entry("codeanalyzer_dead_code_finder", "mcp_code_analyzer", "dead_code_finder",
           category="refactor", description="Find unused code", parallel_ok=True),
    _entry("codeanalyzer_code_metrics", "mcp_code_analyzer", "code_metrics",
           category="refactor", description="Calculate code metrics", parallel_ok=True),
    _entry("codeanalyzer_find_duplications", "mcp_code_analyzer", "find_duplications",
           category="refactor", description="Find duplicated code blocks", parallel_ok=True),

    # ── Path Resolver ──
    _entry("pathresolver_resolve_path", "mcp_path_resolver", "resolve_path",
           category="files", description="Resolve relative/absolute paths", parallel_ok=True),
    _entry("pathresolver_normalize_path", "mcp_path_resolver", "normalize_path",
           category="files", description="Normalize path for platform", parallel_ok=True),
    _entry("pathresolver_get_workspace_roots", "mcp_path_resolver", "get_workspace_roots",
           category="files", description="Detect workspace roots", parallel_ok=True),
    _entry("pathresolver_is_path_allowed", "mcp_path_resolver", "is_path_allowed",
           category="files", description="Check path against allowlist", parallel_ok=True),
    _entry("pathresolver_path_to_url", "mcp_path_resolver", "path_to_url",
           category="files", description="Convert path to file:// URL", parallel_ok=True),
    _entry("pathresolver_url_to_path", "mcp_path_resolver", "url_to_path",
           category="files", description="Convert file:// URL to path", parallel_ok=True),
    _entry("pathresolver_get_path_info", "mcp_path_resolver", "get_path_info",
           category="files", description="Get path metadata", parallel_ok=True),
    _entry("pathresolver_join_paths", "mcp_path_resolver", "join_paths",
           category="files", description="Safely join path components", parallel_ok=True),
    _entry("pathresolver_split_path", "mcp_path_resolver", "split_path",
           category="files", description="Split path into components", parallel_ok=True),
    _entry("pathresolver_relative_to", "mcp_path_resolver", "relative_to",
           category="files", description="Compute relative path", parallel_ok=True),

    # ── Pylint ──
    _entry("pylint_lint_file", "mcp_pylint", "lint_file",
           category="debug", description="Lint a single Python file"),
    _entry("pylint_lint_project", "mcp_pylint", "lint_project",
           category="debug", description="Lint entire project"),
    _entry("pylint_lint_string", "mcp_pylint", "lint_string",
           category="debug", description="Lint code from string"),
    _entry("pylint_get_pylint_version", "mcp_pylint", "get_pylint_version",
           category="debug", description="Get pylint version", parallel_ok=True),
    _entry("pylint_parse_pylint_output", "mcp_pylint", "parse_pylint_output",
           category="debug", description="Parse raw pylint output", parallel_ok=True),
    _entry("pylint_suggest_fixes", "mcp_pylint", "suggest_fixes",
           category="debug", description="Get fix suggestions for pylint messages", parallel_ok=True),
])
